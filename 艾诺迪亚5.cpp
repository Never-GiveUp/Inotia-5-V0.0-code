...
int main() {
	...
	if(ch==1) {
		...
		Slowsay("后记：\n\n");
		Sleep(1000);
		Slowsay("前几个星期看见一个帖子，是一位已经退役的OIer写的\n");
		Sleep(1000);
		Slowsay("他说，6年来，自己走过了千千万万条弯路，至今，机房里那些奋斗的身影还历历在目\n");
		Sleep(1000);
		Slowsay("6年前，12岁的他立下誓言：I will AK IOI!\n");
		Sleep(1000);
		Slowsay("但六年过去了，他终究没能达到这个目标\n");
		Sleep(1000);
		system("cls");
		Slowsay("不过，他觉得，一切都很值得，因为他也收获了许多宝贵的东西\n");
		Sleep(1000); 
		Slowsay("在过去的岁月，他经历的小事还清清楚楚地记得\n");
		Sleep(1000);
		system("cls");	
		Sleep(1000);
		Slowsay("所以，当你踏上了信息学竞赛这条路时，不用反悔，即使你没能达成你的目标，oi之路永远是一段温暖的旅程，虽然只有6年，但它会陪伴你一生，始你终生难忘\n");
		Sleep(1500);
		system("cls");
		Slowsay("加油吧，少年！\n");
		Sleep(2500);
